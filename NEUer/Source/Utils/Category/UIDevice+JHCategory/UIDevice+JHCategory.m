...
@implementation UIDevice (JHCategory)

- (JHDeviceType)deviceType {
...
// 获取设备型号然后手动转化为对应名称
- (NSString *)deviceName {
    JHDeviceType deviceType = [self deviceType];
    return iDeviceNameContainer[deviceType].copy;
}
